package com.genetic.dealer.customui;
...
public class OtpEditText extends AppCompatEditText {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        super.setTransformationMethod(new AsteriskTransformationMethod());
        //Disable copy paste
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float mCharSize;
        boolean passwordInputType = isPasswordInputType(getInputType());
        if (mSpace < 0) {
        ...
        getPaint().setColor(getContext().getColor(R.color.black));
        ...
        for (int i = 0; i < mNumChars; i++) {
            ...
            if (getText().length() > i) {
                ...
                if (passwordInputType) {
                    ...
                    canvas.drawText(asterisk.toString(), i, i + 1, middle - textWidths[0] / 2, bottom - mLineSpacing, getPaint());
                } else {
